namespace Problem1
{
    ...
    public class StartUp
    {
        ...
        public const string ConnectionStringMaster = @"Server=.\SQLEXPRESS;;Integrated Security=True";
        public const string ConnectionStringMinionsDB = @"Server=.\SQLEXPRESS;Database=MinionsDB;Integrated Security=True";
